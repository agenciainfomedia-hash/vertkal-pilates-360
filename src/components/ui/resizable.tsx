...
// Combine PanelResizeHandleProps with standard HTMLDivElement attributes
// to ensure className and ref are present, and add our custom 'withHandle' prop.
...
>(({ withHandle, className, ...props }, ref) => (
  <PanelResizeHandle
    ref={ref} // This should now be correctly typed
    className={cn(

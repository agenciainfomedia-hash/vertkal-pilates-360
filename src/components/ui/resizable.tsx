...
const ResizableHandleComponent = React.forwardRef<
  React.ElementRef<typeof PanelResizeHandle>, // The type of the ref for PanelResizeHandle
  React.ComponentPropsWithoutRef<typeof PanelResizeHandle> & { // The props for PanelResizeHandle, excluding its own ref
    withHandle?: boolean
  }

...
// We also explicitly extend React.HTMLAttributes<HTMLDivElement> to ensure 'className' is always present.
...
const ResizableHandleComponent = React.forwardRef<
  ...
  ResizableHandleComponentProps // Use our custom props interface, which now correctly includes 'ref' and 'className'
